...
1. Comprendre les types d'applications (natives, web, cross-platform) et frameworks.
2. Comprendre le rôle des fonctions spéciales, acteurs et capteurs sensoriels (GPS, caméra, gyroscope, reconnaissance et génération audio)
...
1. Identifier les possibilités et les conditions de publication (PlayStore, AppStore, PWA)
2. Connaître les étapes nécessaires à la publication (build, tests, soumission)
...
1. Comprendre des procédures de tests pour vérifier les exigences fonctionnelles d'applications sur des appareils mobiles
2. Comprendre des procédures de tests pour vérifier des exigences non-fonctionnelles (portabilité, ergonomie, sécurité, UX) d'application sur des appareils mobiles.
