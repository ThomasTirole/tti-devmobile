...
- **développer** une application &rarr; consiste à concevoir et développer des fonctionnalités.
- **publier** une application &rarr; signifie rendre l'app disponible via un store ou un canal de distribution.
- **commercialiser** une application &rarr; consiste à la proposer à un public avec une logique de valeur.
...
Les stores d'applications jouent le rôle de **vitrines numériques**. Être publié ne garantit **aucune visibilité**.
Le placement repose donc sur plusieurs éléments :
...
::: details 🆓 Applications gratuites
...
Dans ce modèle, l'utilisateur **ne paie pas directement**, et les revenus reposent sur le volume d'utilisateur, le temps passé dans l'application et donc le nombre d'impressions publicitaires.
...
Dans ces cas-là, on dit généralement que l'expérience utilisateur est pensée autour de la publicité. Par exemple, les studios **_Voodoo_** et **_SayGames_** ont popularisé des jeux **très simples**, **gratuits** et fortement **financés par la publicité**.
Ces jeux attirent via des publicités courtes sur les réseaux sociaux et génèrent des revenus principalement par les vidéos récompensées et les interstitiels.
:::
...
La pression économique liée à la monétisation a conduit à certaines pratiques controversées, largement documentées ces dernières années. L’une des plus visibles est celle des **publicités trompeuses**, souvent appelées _fake ads_.

![fake-mobile-apps.gif](/4.3/fake-mobile-apps.gif)

Ces publicités montrent un gameplay ou des fonctionnalités qui n’existent pas réellement dans l’application finale. Des médias comme _Vox_ ou _The Guardian_ ont mis en évidence que ces pratiques augmentent significativement le taux d’installation, mais entraînent également une forte frustration chez les utilisateurs.

::: warning Le modèle repose alors sur :
...
Un utilisateur de Reddit s'est prononcé sur ce sujet, et j'ai trouvé son avis intéressant, je vous propose donc un résumé de son post [(le post original ici)](https://www.reddit.com/r/AndroidGaming/comments/1iqy32g/why_fake_ads_dominate_mobile_gamesand_why_theyre/)
...
- Instagram Reels ;
- YouTube Shorts ;
... permettent de créer une visibilité rapide, mais accentuent aussi le risque de décalage entre la promesse et la réalité.
...
* [Vox – Why mobile game ads lie](https://www.vox.com/the-goods/2019/12/13/21011706/mobile-game-ads-fake-gameplay)
* [The Guardian – Deceptive mobile game advertising](https://www.theguardian.com/games/2020/feb/14/mobile-game-ads-deceptive)
* [GameRefinery – Hyper-casual monetization](https://www.gamerefinery.com/hypercasual-monetization/)
* [Sensor Tower – Mobile app monetization trends](https://sensortower.com/blog/app-monetization-trends)
