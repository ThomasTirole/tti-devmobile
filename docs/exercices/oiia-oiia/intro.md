...
- créer un projet Ionic Vue Capacitor
- Accéder aux capteurs natifs du telephone (gyroscope) via un plugin Capacitor
- créer un **composable Vue** réutilisable
- gérer de l'audio et des animations CSS
- Configurer et déployer sur Android

<img src="/exercices/oiia-oiia/spinning-cat.gif" width="250" height="250">
